...
export class GifExporter {
  ...
  async export(): Promise<ExportResult> {
    try {
      ...
      const effectiveDuration = this.streamingDecoder.getEffectiveDuration(this.config.trimRegions) / this.playbackRate;
      ...
      console.log('[GifExporter] Effective duration (with speed):', effectiveDuration, 's');
      ...
      await this.streamingDecoder.decodeAll(
        ...
        async (videoFrame, _exportTimestampUs, sourceTimestampMs) => {
          ...
          if (typeof OffscreenCanvas !== 'undefined' && canvas instanceof OffscreenCanvas) {
             ...
             this.gif!.addFrame(imgData, { delay: frameDelay, copy: true });
          } else {
             this.gif!.addFrame(canvas as HTMLCanvasElement, { delay: frameDelay, copy: true });
          }
