...
export class FrameRenderer {
	...
	async initialize(): Promise<void> {
		...
		this.compositeCtx = this.compositeCanvas.getContext("2d", { willReadFrequently: false }) as
		...
		if (this.config.showShadow) {
			...
			this.shadowCtx = this.shadowCanvas.getContext("2d", { willReadFrequently: false }) as
				| CanvasRenderingContext2D
				| OffscreenCanvasRenderingContext2D;
