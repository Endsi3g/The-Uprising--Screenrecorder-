...
import { Command, Image as ImageIcon, Sparkles, Video } from "lucide-react";
...
export function ChangelogDialog() {
	...
	return (
		<Dialog.Root open={open} onOpenChange={setOpen}>
			...
			<Dialog.Portal>
				<Dialog.Overlay
					className={`fixed inset-0 bg-black/60 backdrop-blur-sm z-50 ${styles.overlay}`}
				/>
				<Dialog.Content
					className={`fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-[#18181b] border border-white/10 rounded-xl shadow-2xl z-50 overflow-hidden flex flex-col ${styles.content}`}
				>
					{/* Header Banner */}
					<div className="relative h-32 bg-indigo-600 overflow-hidden flex items-center justify-center">
						...
						<div className="relative z-10 text-center">
							...
							<p className="text-indigo-200 font-medium tracking-widest uppercase text-xs mt-1">
					...
					<div className="p-6 overflow-y-auto max-h-[60vh] custom-scrollbar text-zinc-300 space-y-6">
						...
						<div className="space-y-2">
							...
							<p className="text-sm leading-relaxed">
								Add a personal touch to your recordings. Launch a seamless, transparent WebCam
								overlay directly from your HUD that floats above your workspace and is effortlessly
								captured in your final video.
							</p>
						</div>
						...
						<div className="space-y-2">
							...
							<p className="text-sm leading-relaxed">
								Our ultra-fast, browser-based Speech-to-Text engine now fully embeds caption tracks
								directly into your exported MP4 and GIF videos. Perfect for silent scroll-stopping
								content!
							</p>
						</div>
						...
						<div className="space-y-2">
							...
							<p className="text-sm leading-relaxed">
								Brand new official logo for The Uprising, better adaptive titlebars and traffic
								lights for Mac users, and improved mobile dashboard access.
							</p>
						</div>
					</div>
