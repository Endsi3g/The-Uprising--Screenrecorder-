import { FileDown, FolderOpen, Menu, Plus, Save } from "lucide-react";
	...
	return (
		<>
			<DropdownMenu>
				...
				<DropdownMenuContent
					align="start"
					className="w-56 bg-[#09090b] border-white/10 text-slate-200"
				>
					<DropdownMenuItem
						onClick={() => handleActionWithWarning("new")}
					...
					<DropdownMenuItem
						onClick={() => handleActionWithWarning("open")}
						className="hover:bg-white/10 cursor-pointer focus:bg-white/10"
					>
