						...
						<AccordionContent className="pb-3">
							<Tabs defaultValue="image" className="w-full">
								<TabsList className="mb-2 bg-white/5 border border-white/5 p-0.5 w-full grid grid-cols-3 h-7 rounded-lg">
									<TabsTrigger
										value="image"
										className="data-[state=active]:bg-[#3B82F6] data-[state=active]:text-white text-slate-400 text-[10px] py-1 rounded-md transition-all"
									>
										Image
									</TabsTrigger>
									<TabsTrigger
							...
							<div className="grid grid-cols-3 gap-2">
								<div className="space-y-1">
									<label
										...
										className="text-[9px] text-slate-500 uppercase font-semibold"
									>
										Width
									</label>
									<input
