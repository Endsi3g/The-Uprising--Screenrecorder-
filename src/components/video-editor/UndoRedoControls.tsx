      ...
      <div className="flex items-center gap-1 bg-[#1a1a1a] rounded-lg p-0.5 border border-white/5">
        <Tooltip>
          ...
          <TooltipContent side="bottom" className="text-xs bg-[#2a2a2a] border-white/10">
            <p>Undo <kbd className="ml-1 px-1.5 py-0.5 bg-white/10 rounded">{undoShortcut}</kbd></p>
          </TooltipContent>
        </Tooltip>
        ...
        <Tooltip>
          ...
          <TooltipContent side="bottom" className="text-xs bg-[#2a2a2a] border-white/10">
            <p>Redo <kbd className="ml-1 px-1.5 py-0.5 bg-white/10 rounded">{redoShortcut}</kbd></p>
          </TooltipContent>
        </Tooltip>
      </div>
    </TooltipProvider>
